...
3. `screens.md` — Screen flow per feature + Screen Route Table.
...
| Screen Flow | `screens.md` | Screen Route Table + user journey |
...
- Screen Route Table (3-column: Screen | Route | Purpose) MANDATORY for UI/mixed features.
- Write `N/A — background feature; no user-facing screen flow.` for background-only features.
