...
export const mockKudos: Kudos[] = [
  { id: "k1", sender: u[0], receiver: u[1], awardTitle: "Idol giới trẻ", contentVi: "Cảm ơn người em bình thường nhưng phi thường :D Cảm ơn sự chăm chỉ, cẩn mẫn và tinh thần luôn hỗ trợ đồng đội của bạn. Bạn là nguồn cảm hứng lớn cho cả team!", hashtags: ["#Dedicated", "#Inspiring", "IDOL GIỚI TRẺ"], imageUrls: ["/shared/user-profile.svg", "/shared/user-profile.svg", "/shared/user-profile.svg", "/shared/user-profile.svg", "/shared/user-profile.svg"], likeCount: 1000, likedByMe: false, isOwn: false, postedAt: "10:00 - 10/30/2025" },
  { id: "k2", sender: u[2], receiver: u[3], awardTitle: "Người mentor tuyệt vời", contentVi: "Chị ơi, cảm ơn chị đã luôn sẵn sàng chia sẻ kinh nghiệm và hỗ trợ em trong những lúc khó khăn nhất. Chị là người mentor tuyệt vời mà em may mắn được làm việc cùng!", hashtags: ["#Teamwork", "#Mentor"], imageUrls: [], likeCount: 256, likedByMe: true, isOwn: false, postedAt: "14:30 - 11/02/2025" },
  { id: "k3", sender: u[4], receiver: u[5], awardTitle: "Trụ cột của team", contentVi: "Cảm ơn bạn đã xử lý một mình toàn bộ ticket khó trong sprint vừa rồi. Nhờ bạn mà dự án không bị delay. Bạn thật sự là trụ cột của team!", hashtags: ["#Hero", "#Dedicated", "#Inspiring"], imageUrls: ["/shared/user-profile.svg"], likeCount: 512, likedByMe: false, isOwn: false, postedAt: "09:15 - 11/05/2025" },
  { id: "k4", sender: u[6], receiver: u[7], awardTitle: "Người review tận tâm", contentVi: "Cảm ơn anh đã review code cực kỳ kỹ lưỡng và chỉ ra rất nhiều điểm cần cải thiện cho em. Nhờ anh mà chất lượng code của em ngày càng tốt hơn!", hashtags: ["#CodeQuality", "#Mentor"], imageUrls: [], likeCount: 88, likedByMe: false, isOwn: true, postedAt: "16:45 - 11/08/2025" },
  { id: "k5", sender: u[8], receiver: u[9], awardTitle: "Ánh nắng văn phòng", contentVi: "Cảm ơn bạn đã luôn vui vẻ và tràn đầy năng lượng mỗi ngày, làm cho không khí làm việc của cả team trở nên dễ chịu hơn rất nhiều. Bạn là ánh nắng của văn phòng!", hashtags: ["#Positivity", "#TeamSpirit", "#Inspiring"], imageUrls: ["/shared/user-profile.svg", "/shared/user-profile.svg"], likeCount: 320, likedByMe: true, isOwn: false, postedAt: "08:00 - 11/10/2025" },
  { id: "k6", sender: u[10], receiver: u[11], awardTitle: "Người đồng hành onboarding", contentVi: "Cảm ơn chị đã hỗ trợ onboarding và giúp em hiểu rõ hơn về các quy trình của công ty. Nhờ có chị mà những tuần đầu đi làm của em trở nên thật dễ dàng!", hashtags: ["#Onboarding", "#Dedicated"], imageUrls: [], likeCount: 145, likedByMe: false, isOwn: false, postedAt: "11:20 - 11/12/2025" },
  { id: "k7", sender: u[1], receiver: u[0], awardTitle: "Người truyền cảm hứng", contentVi: "Bạn đã làm rất tốt trong buổi demo với khách hàng tuần rồi. Khả năng trình bày rõ ràng và xử lý các câu hỏi khó của bạn thực sự ấn tượng!", hashtags: ["#Communication", "#Professional"], imageUrls: ["/shared/user-profile.svg", "/shared/user-profile.svg", "/shared/user-profile.svg"], likeCount: 198, likedByMe: false, isOwn: false, postedAt: "13:00 - 11/15/2025" },
  { id: "k8", sender: u[3], receiver: u[2], awardTitle: "Tinh thần trách nhiệm", contentVi: "Cảm ơn anh đã làm overtime cùng team để hoàn thành milestone đúng hạn. Tinh thần trách nhiệm và sự hi sinh của anh thật sự đáng trân trọng!", hashtags: ["#Dedication", "#Teamwork", "IDOL GIỚI TRẺ"], imageUrls: [], likeCount: 775, likedByMe: true, isOwn: false, postedAt: "17:30 - 11/20/2025" },
];
